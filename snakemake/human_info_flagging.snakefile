...
rule target:
    input:
        "../data/mismatch-flagging2-V3/human_Exon_map.tab",
        "../data/mismatch-flagging2-V3/human_Intron_map.tab",
        "../data/mismatch-flagging2-V3/human_CDS_all_corrected_filt.fasta",
        "../data/mismatch-flagging2-V3/human_genomic_all_corrected_filt.fasta",
        "../data/mismatch-flagging2-V3/human_mismatch_exon_pos.tab",
        "../data/mismatch-flagging2-V3/human_mismatch_exon_seq.tab",
        "../data/mismatch-flagging2-V3/human_mismatch_intron_seq.tab",
        "../data/mismatch-flagging2-V3/human_mismatch_CDS_seq.tab",
        "../data/mismatch-flagging2-V3/human_mismatch_genomic_seq.tab",
...
rule colocalise_on_exon_introns:
    input:
        "../data/mismatch-flagging2-V3/uniprot_errors_type3.txt", 
        "../data/mismatch-flagging2-V3/human_CDS_all_corrected_filt.fasta",
        "../data/mismatch-flagging2-V3/human_Exon_map.tab",
        "../data/mismatch-flagging2-V3/human_Intron_map.tab"
    output:
...
rule create_exon_map:
    input:
        "../data/mismatch-flagging2-V3/human_transcript_ensembl_corrected2.tab", 
        "../data/mismatch-flagging2-V3/human_exon_json_dump.json", 
        "../data/mismatch-flagging2-V3/human_genomic_all_corrected_filt.fasta"
    output:
        "../data/mismatch-flagging2-V3/human_Exon_map.tab", "../data/mismatch-flagging2-V3/human_Intron_map.tab"
    message:
...
rule filt_cds_genom:
    input:
        ...
        "../data/mismatch-flagging2-V3/human_genomic_all_corrected.fasta"
    output:
        "../data/mismatch-flagging2-V3/human_CDS_all_corrected_filt.fasta", 
        "../data/mismatch-flagging2-V3/human_genomic_all_corrected_filt.fasta"
    message:
...
rule fix_genomic_cds:
    input:
        "../data/mismatch-flagging2-V3/human_transcript_ensembl.tab",
        "../data/mismatch-flagging2-V3/human_CDS_all.fasta",
        "../data/mismatch-flagging2-V3/human_genomic_all.fasta"
    output:
        "../data/mismatch-flagging2-V3/human_CDS_all_corrected.fasta",
        "../data/mismatch-flagging2-V3/human_genomic_all_corrected.fasta"
    message:
...
rule get_SEQ_and_ID_errors:
    input:
        "../data/mismatch-flagging2-V3/mismatch_human.id"
    output:
        "../data/mismatch-flagging2-V3/human_transcript_ensembl.tab"
    message:
